...
CreateConVar("ttt_detective_karma_min", "760")
...
function BeginRound()
   ...
   -- Reset Jetpack Fuel if players have a jetpack
   timer.Simple(0, ResetFuel)
...
function ResetFuel()
	for _,v in pairs(player.GetAll()) do
		if v:GetNWFloat("JetPack") == 1 then
			v:SetNWFloat("JetFuel", 100)
		end
	end
	return
end
