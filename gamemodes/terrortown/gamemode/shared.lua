...
GM.Author = "Rebuilt by Shadow"
GM.Email = "gmshadowmaru@hotmail.com"
GM.Website = "true-og.webs.com"
GM.Version = "42.1"
...
WIN_INNOCENT  = 3
WIN_TIMELIMIT = 4
WIN_ZOMBIE    = 5 -- Added For ZombieMode
WIN_SURVIVOR  = 6 -- Added For ZombieMode
