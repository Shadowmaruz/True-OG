...
function GM:TTTScoreboardColorForPlayer(ply)
   ...
   if ply:SteamID() == "STEAM_0:1:47635141" then
...
function PANEL:UpdatePlayerData()
   ...
   if self.cols[4] then
	  local KarmaP = math.Round(ply:GetBaseKarma()/10)
	  if KarmaP == 200 then
	     self.cols[4]:SetTextColor(Color(75,108,251))
	  elseif KarmaP <= 199 and KarmaP >= 101 then
	     self.cols[4]:SetTextColor(Color(68,247,49))
	  elseif KarmaP <= 99 and KarmaP >= 75 then
	     self.cols[4]:SetTextColor(Color(220,180,0))
	  elseif KarmaP <= 74 then
	     self.cols[4]:SetTextColor(Color(255,0,0))
	  end
      self.cols[4]:SetText(KarmaP)
   end
...
if ply:IsUserGroup("Owner") then
  ...
  self.cols[5]:SetTextColor(Color(210,0,0))
end
...
if ply:IsUserGroup("superadmin") then
  ...
  self.cols[5]:SetTextColor(Color(176,176,0))
end
   
if ply:IsUserGroup("admin") then
  self.cols[5]:SetText("Admin")
  self.cols[5]:SetTextColor(Color(255,0,255))
end
   
if ply:IsUserGroup("Donor") then
  self.cols[5]:SetText("Donator")
  self.cols[5]:SetTextColor(Color(250,67,67))
end
    
if ply:IsUserGroup("Pre-Admin") then
  self.cols[5]:SetText("Pre-Admin")
  self.cols[5]:SetTextColor(Color(26,246,243))
end
...
if ply:IsUserGroup("Pre-Mod") then
  self.cols[5]:SetText("Pre-Mod")
  self.cols[5]:SetTextColor(Color(75,108,251))
end
 
if ply:IsUserGroup("Trusted") then
  self.cols[5]:SetText("Trusted")
  self.cols[5]:SetTextColor(Color(0,255,160))
end
...
function PANEL:LayoutColumns()
   for k,v in ipairs(self.cols) do
      v:SizeToContents()
      v:SetPos(self:GetWide() - (50*k) - v:GetWide()/2, (SB_ROW_HEIGHT - v:GetTall()) / 2) -- 20 nondefault
      if v == self.cols[5] then
        v:SetPos(self:GetWide() - (85*k) - v:GetWide()/2, (SB_ROW_HEIGHT - v:GetTall()) / 2) -- 55 nondefault
            end
   end
