...
cl_crosshair_t 		= CreateClientConVar("mad_crosshair_t", 0, true, false)		// Enable/Disable
...
function SWEP:DrawHUD()
	...
	local gap = (bit.tobit(self.Primary.Cone * 275) + (((self.Primary.Cone * 275) * (ScrH() / 720))) * (1 / self:CrosshairAccuracy())) * 0.75
