...
if ( CLIENT ) then
	...
	SWEP.WElements = {
		["silencer"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", pos = Vector(19.233, 1.531, -6.382), angle = Angle(-99.576, 0, 0), size = Vector(0.043, 0.043, 0.15), color = Color(255, 255, 255, 1), surpresslightning = false, material = "models/bunneh/silencer", skin = 0, bodygroup = {} }
	}
